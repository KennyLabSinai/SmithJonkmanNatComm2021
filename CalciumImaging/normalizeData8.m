% written by Mark, modified by Mike and Alex
function [data, pre] = normalizeData8(data, pre)
...
N = size(data,3);
data = bsxfun( @minus, data+floor(255*1024/65535), imclose(pre.fmin, strel('disk',5))); % subtract a smoothed version of the min map
